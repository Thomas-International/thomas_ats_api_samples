 ...
 */
@Schema(description = "Object representing a Job Role Assessment Order object to create")
...
public class JobRoleAssessmentOrderRequest {
  ...
  public JobRoleAssessmentOrderRequest id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public JobRoleAssessmentOrderRequest email(String email) {
    this.email = email;
    return this;
  }
  ...
  **/
  ...
  public JobRoleAssessmentOrderRequest roleId(UUID roleId) {
    this.roleId = roleId;
    return this;
  }
   ...
   * @return roleId
  **/
  @Schema(required = true, description = "The ID of the Job Role")
  ...
  public JobRoleAssessmentOrderRequest callbackUrl(String callbackUrl) {
    this.callbackUrl = callbackUrl;
    return this;
  }

   /**
   * The callback url to send Assessments results  Example: https://yourapi.example.com/notifyResults/
   * @return callbackUrl
  **/
  @Schema(description = "The callback url to send Assessments results  Example: https://yourapi.example.com/notifyResults/")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    JobRoleAssessmentOrderRequest jobRoleAssessmentOrderRequest = (JobRoleAssessmentOrderRequest) o;
    return Objects.equals(this.id, jobRoleAssessmentOrderRequest.id) &&
        Objects.equals(this.email, jobRoleAssessmentOrderRequest.email) &&
        Objects.equals(this.roleId, jobRoleAssessmentOrderRequest.roleId) &&
        Objects.equals(this.callbackUrl, jobRoleAssessmentOrderRequest.callbackUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, email, roleId, callbackUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobRoleAssessmentOrderRequest {\n");
