...
/**
 * Gets or Sets JobRoleCharacteristic
 */
@JsonAdapter(JobRoleCharacteristic.Adapter.class)
public enum JobRoleCharacteristic {
  ANALYTICAL("Analytical"),
  COMMUNICATIVE("Communicative"),
  DECISIVE("Decisive"),
  DRIVEN("Driven"),
  EMOTIONALLYRESILIENT("EmotionallyResilient"),
  ...
  JobRoleCharacteristic(String value) {
    this.value = value;
  }
  ...
  public static JobRoleCharacteristic fromValue(String input) {
    for (JobRoleCharacteristic b : JobRoleCharacteristic.values()) {
  ...
  public static class Adapter extends TypeAdapter<JobRoleCharacteristic> {
    @Override
    public void write(final JsonWriter jsonWriter, final JobRoleCharacteristic enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public JobRoleCharacteristic read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return JobRoleCharacteristic.fromValue((String)(value));
    }
  }
}
