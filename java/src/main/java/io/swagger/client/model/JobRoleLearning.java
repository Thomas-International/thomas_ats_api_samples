...
/**
 * Gets or Sets JobRoleLearning
 */
@JsonAdapter(JobRoleLearning.Adapter.class)
public enum JobRoleLearning {
  NONE("None"),
  INITIAL("Initial"),
  ONGOING("Ongoing"),
  CONSTANT("Constant");
  ...
  public static JobRoleLearning fromValue(String input) {
    for (JobRoleLearning b : JobRoleLearning.values()) {
  ...
  public static class Adapter extends TypeAdapter<JobRoleLearning> {
    @Override
    public void write(final JsonWriter jsonWriter, final JobRoleLearning enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public JobRoleLearning read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return JobRoleLearning.fromValue((String)(value));
    }
  }
}
