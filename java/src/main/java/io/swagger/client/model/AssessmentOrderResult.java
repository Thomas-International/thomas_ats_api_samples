 ...
 */
@Schema(description = "Object representing a Assessment Order result")
...
public class AssessmentOrderResult {
  ...
  public AssessmentOrderResult id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public AssessmentOrderResult complete(Boolean complete) {
  ...
  **/
  ...
  public AssessmentOrderResult results(Results results) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssessmentOrderResult assessmentOrderResult = (AssessmentOrderResult) o;
    return Objects.equals(this.id, assessmentOrderResult.id) &&
        Objects.equals(this.complete, assessmentOrderResult.complete) &&
        Objects.equals(this.results, assessmentOrderResult.results);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssessmentOrderResult {\n");
