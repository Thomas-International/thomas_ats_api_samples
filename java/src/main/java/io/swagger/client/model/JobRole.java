 ...
 */
@Schema(description = "Object representing a Job Role")
...
public class JobRole {
  ...
  private List<JobRoleCharacteristic> characteristics = null;

  public JobRole id(UUID id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(description = "Job Role ID")
  public UUID getId() {
    return id;
  }
  ...
  public JobRole title(String title) {
    this.title = title;
    return this;
  }
   ...
   * @return title
  **/
  @Schema(description = "Title of the Job Role")
  ...
  public JobRole description(String description) {
   ...
   * @return description
  **/
  @Schema(description = "Longer description of the Job Role, including any necessary criteria")
  ...
  public JobRole level(JobRoleLevel level) {
    this.level = level;
    return this;
  }
  ...
  **/
  ...
  public JobRole learning(JobRoleLearning learning) {
  ...
  **/
  ...
  public JobRole pace(JobRolePace pace) {
    this.pace = pace;
    return this;
  }
  ...
  **/
  ...
  public JobRole variety(JobRoleVariety variety) {
  ...
  **/
  ...
  public JobRole characteristics(List<JobRoleCharacteristic> characteristics) {
    this.characteristics = characteristics;
    return this;
  }

  public JobRole addCharacteristicsItem(JobRoleCharacteristic characteristicsItem) {
    if (this.characteristics == null) {
      this.characteristics = new ArrayList<JobRoleCharacteristic>();
    }
   ...
   /**
   * Core characteristics. Exactly three different (unique) values must be selected:  Analytical, Communicative, Decisive, Driven, Emotionally, Resilient, Independent, Innovative, ProcessOriented, Supportive
   * @return characteristics
  **/
  @Schema(description = "Core characteristics. Exactly three different (unique) values must be selected:  Analytical, Communicative, Decisive, Driven, Emotionally, Resilient, Independent, Innovative, ProcessOriented, Supportive")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, jobRole.id) &&
        Objects.equals(this.title, jobRole.title) &&
        Objects.equals(this.description, jobRole.description) &&
        Objects.equals(this.level, jobRole.level) &&
        Objects.equals(this.learning, jobRole.learning) &&
        Objects.equals(this.pace, jobRole.pace) &&
        Objects.equals(this.variety, jobRole.variety) &&
        Objects.equals(this.characteristics, jobRole.characteristics);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, title, description, level, learning, pace, variety, characteristics);
  }
