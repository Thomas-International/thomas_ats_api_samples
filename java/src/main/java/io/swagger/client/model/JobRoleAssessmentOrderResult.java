...
import io.swagger.client.model.JobRoleResults;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * Object representing an Assessment Order result
 */
@Schema(description = "Object representing an Assessment Order result")
...
public class JobRoleAssessmentOrderResult {
  ...
  private JobRoleResults results = null;

  public JobRoleAssessmentOrderResult id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public JobRoleAssessmentOrderResult complete(Boolean complete) {
   ...
   * @return complete
  **/
  @Schema(description = "This will be true if the candidate has completed all of the required assessments and a score is available")
  ...
  public JobRoleAssessmentOrderResult results(JobRoleResults results) {
  ...
  **/
  @Schema(description = "")
  public JobRoleResults getResults() {
    return results;
  }

  public void setResults(JobRoleResults results) {
    this.results = results;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    JobRoleAssessmentOrderResult jobRoleAssessmentOrderResult = (JobRoleAssessmentOrderResult) o;
    return Objects.equals(this.id, jobRoleAssessmentOrderResult.id) &&
        Objects.equals(this.complete, jobRoleAssessmentOrderResult.complete) &&
        Objects.equals(this.results, jobRoleAssessmentOrderResult.results);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, complete, results);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobRoleAssessmentOrderResult {\n");
