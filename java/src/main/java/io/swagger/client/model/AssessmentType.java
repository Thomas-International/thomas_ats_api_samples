 ...
 */
@JsonAdapter(AssessmentType.Adapter.class)
public enum AssessmentType {
  ...
  public static AssessmentType fromValue(String input) {
  ...
  public static class Adapter extends TypeAdapter<AssessmentType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AssessmentType enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public AssessmentType read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return AssessmentType.fromValue((String)(value));
    }
  }
}
