...
/**
 * Gets or Sets JobRoleLevel
 */
@JsonAdapter(JobRoleLevel.Adapter.class)
public enum JobRoleLevel {
  ...
  public static JobRoleLevel fromValue(String input) {
    for (JobRoleLevel b : JobRoleLevel.values()) {
  ...
  public static class Adapter extends TypeAdapter<JobRoleLevel> {
    @Override
    public void write(final JsonWriter jsonWriter, final JobRoleLevel enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public JobRoleLevel read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return JobRoleLevel.fromValue((String)(value));
    }
  }
}
