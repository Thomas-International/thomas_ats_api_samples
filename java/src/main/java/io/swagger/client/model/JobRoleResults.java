...
import io.swagger.client.model.AssessmentScores;
import io.swagger.client.model.StarRatings;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
/**
 * Object representing a Job Role Results
 */
@Schema(description = "Object representing a Job Role Results")
...
public class JobRoleResults {
  ...
  private StarRatings starRatings = null;

  @SerializedName("assessmentScores")
  private AssessmentScores assessmentScores = null;

  public JobRoleResults starRatings(StarRatings starRatings) {
  ...
  **/
  ...
  public JobRoleResults assessmentScores(AssessmentScores assessmentScores) {
  ...
  **/
  @Schema(description = "")
  public AssessmentScores getAssessmentScores() {
    return assessmentScores;
  }

  public void setAssessmentScores(AssessmentScores assessmentScores) {
    this.assessmentScores = assessmentScores;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    JobRoleResults jobRoleResults = (JobRoleResults) o;
    return Objects.equals(this.starRatings, jobRoleResults.starRatings) &&
        Objects.equals(this.assessmentScores, jobRoleResults.assessmentScores);
  }

  @Override
  public int hashCode() {
    return Objects.hash(starRatings, assessmentScores);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobRoleResults {\n");
    
    sb.append("    starRatings: ").append(toIndentedString(starRatings)).append("\n");
    sb.append("    assessmentScores: ").append(toIndentedString(assessmentScores)).append("\n");
    sb.append("}");
    return sb.toString();
  }
