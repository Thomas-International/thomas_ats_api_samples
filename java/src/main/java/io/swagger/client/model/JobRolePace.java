...
/**
 * Gets or Sets JobRolePace
 */
@JsonAdapter(JobRolePace.Adapter.class)
public enum JobRolePace {
  SLOW("Slow"),
  MODERATE("Moderate"),
  FAST("Fast"),
  ...
  public static JobRolePace fromValue(String input) {
    for (JobRolePace b : JobRolePace.values()) {
  ...
  public static class Adapter extends TypeAdapter<JobRolePace> {
    @Override
    public void write(final JsonWriter jsonWriter, final JobRolePace enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public JobRolePace read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return JobRolePace.fromValue((String)(value));
    }
  }
}
