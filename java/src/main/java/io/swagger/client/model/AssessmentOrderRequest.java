...
import io.swagger.client.model.AssessmentType;
 ...
 */
@Schema(description = "Object representing an Assessment Order object to create")
...
public class AssessmentOrderRequest {
  ...
  private List<AssessmentType> assessments = new ArrayList<AssessmentType>();

  @SerializedName("callbackUrl")
  private String callbackUrl = null;

  public AssessmentOrderRequest id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(description = "An ID to represent this instance of a candidate being tested against a role")
  public String getId() {
    return id;
  }
  ...
  public AssessmentOrderRequest email(String email) {
    this.email = email;
    return this;
  }
   ...
   * @return email
  **/
  @Schema(required = true, description = "The candidate's email address. They will receive an email inviting them to take the tests")
  ...
  public AssessmentOrderRequest assessments(List<AssessmentType> assessments) {
    this.assessments = assessments;
    return this;
  }

  public AssessmentOrderRequest addAssessmentsItem(AssessmentType assessmentsItem) {
    this.assessments.add(assessmentsItem);
    return this;
  }

   /**
   * The assessments to request the candidate completes  Example: List [ \&quot;Aptitude\&quot;, \&quot;Behaviour\&quot;, \&quot;Personality\&quot; ]
   * @return assessments
  **/
  @Schema(required = true, description = "The assessments to request the candidate completes  Example: List [ \"Aptitude\", \"Behaviour\", \"Personality\" ]")
  public List<AssessmentType> getAssessments() {
    return assessments;
  }

  public void setAssessments(List<AssessmentType> assessments) {
    this.assessments = assessments;
  }

  public AssessmentOrderRequest callbackUrl(String callbackUrl) {
   ...
   * @return callbackUrl
  **/
  @Schema(required = true, description = "The callback url to send assessments results")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AssessmentOrderRequest assessmentOrderRequest = (AssessmentOrderRequest) o;
    return Objects.equals(this.id, assessmentOrderRequest.id) &&
        Objects.equals(this.email, assessmentOrderRequest.email) &&
        Objects.equals(this.assessments, assessmentOrderRequest.assessments) &&
        Objects.equals(this.callbackUrl, assessmentOrderRequest.callbackUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, email, assessments, callbackUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class AssessmentOrderRequest {\n");
