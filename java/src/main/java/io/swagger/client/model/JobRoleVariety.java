...
/**
 * Gets or Sets JobRoleVariety
 */
@JsonAdapter(JobRoleVariety.Adapter.class)
public enum JobRoleVariety {
  ...
  public static JobRoleVariety fromValue(String input) {
    for (JobRoleVariety b : JobRoleVariety.values()) {
  ...
  public static class Adapter extends TypeAdapter<JobRoleVariety> {
    @Override
    public void write(final JsonWriter jsonWriter, final JobRoleVariety enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public JobRoleVariety read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return JobRoleVariety.fromValue((String)(value));
    }
  }
}
