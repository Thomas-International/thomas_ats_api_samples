...
/**
 * API tests for JobRoleApi
 */
@Ignore
public class JobRoleApiTest {

    private final JobRoleApi api = new JobRoleApi();
     ...
     */
    @Test
    public void createJobRoleTest() throws Exception {
        JobRoleRequest body = null;
        JobRole response = api.createJobRole(body);
     ...
     */
    @Test
    public void getJobRoleByIdTest() throws Exception {
        UUID id = null;
        JobRole response = api.getJobRoleById(id);
     ...
     */
    @Test
    public void getJobRolesTest() throws Exception {
        List<JobRole> response = api.getJobRoles();
