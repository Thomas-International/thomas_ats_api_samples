...
/**
 * API tests for AssessmentOrderApi
 */
@Ignore
public class AssessmentOrderApiTest {

    private final AssessmentOrderApi api = new AssessmentOrderApi();
     ...
     */
    @Test
    public void createAssessmentOrderTest() throws Exception {
        AssessmentOrderRequest body = null;
        AssessmentOrderResult response = api.createAssessmentOrder(body);
     ...
     */
    @Test
    public void getAssessmentOrderByIdTest() throws Exception {
        String id = null;
        AssessmentOrderResult response = api.getAssessmentOrderById(id);
