...
/**
 * API tests for JobRoleAssessmentOrderApi
 */
@Ignore
public class JobRoleAssessmentOrderApiTest {

    private final JobRoleAssessmentOrderApi api = new JobRoleAssessmentOrderApi();
     ...
     */
    @Test
    public void createJobRoleAssessmentOrderTest() throws Exception {
        JobRoleAssessmentOrderRequest body = null;
        JobRoleAssessmentOrderResult response = api.createJobRoleAssessmentOrder(body);
     ...
     */
    @Test
    public void getJobRoleAssessmentOrderByIdTest() throws Exception {
        String id = null;
        JobRoleAssessmentOrderResult response = api.getJobRoleAssessmentOrderById(id);
     ...
     */
    @Test
    public void getJobRoleAssessmentOrdersTest() throws Exception {
        String jobRoleId = null;
        Boolean complete = null;
        List<JobRoleAssessmentOrderResult> response = api.getJobRoleAssessmentOrders(jobRoleId, complete);
